    ...
    <div class="compact-card-header">
        ...
        <div class="flex items-center gap-1.5">
            <span class="compact-units">
                {{ $course['units'] ? $course['units'] . ' ' . Str::plural('unit', $course['units']) : '—' }}
            </span>
            {{-- Hover actions --}}
            <div class="compact-actions">
                <button x-on:click="$wire.set('editingMappingId', {{ $course['mapping_id'] }}); $nextTick(() => $wire.mountAction('editCourseMapping'))" title="Edit mapping">
